/**
 * SITE CONFIG — Kumaran M.A. · AKR Social Welfare Trust — ENGLISH
 * -----------------------------------------------------------
 * English content. For Tamil edit /content/site.ta.js
 * -----------------------------------------------------------
 */
...
export const site = {
  ...
  involved: {
    ...
    titleLine1: "This movement belongs to",
    titleItalic: "you.",
    description:
  ...
  forms: {
    volunteer: {
      ...
      successTitle: "You're on board.",
      successBody: "A coordinator will reach out within 48 hours. Welcome to the team.",
      successReset: "Sign up another volunteer",
      toastSuccess: "Thank you for joining the movement!",
    ...
    contact: {
      ...
      successBody: "Thank you for writing in. Our team responds within 2-3 working days.",
